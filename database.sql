...
CREATE TABLE `cthd` (
  ...
  `MaSP` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `hangsanpham` (
  `MaHSP` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `khachhang` VALUES ('C01',' Nguyễn Hữu Tài','Hồ Chí Minh','0987765553'),('C02','Bùi Xuân Thái','Hà Nội','0368556782'),('C03','Trịnh Văn Quý','Bắc Cạn','0956777654'),('C04','Lê Văn Minh','Hải Phòng','0909634257');
...
CREATE TABLE `nhanvien` (
  ...
  `DiaChi` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SDT` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `VaiTro` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `nhanvien` VALUES ('E01','Lê Thanh Bảo','1997-12-03','Hồ Chí Minh','0987684756 ','Nhân viên',1),('E02','Nguyễn Thiện Hiếu','1998-06-07','Hồ Chí Minh','0987654456','Nhân viên',1),('E03','Phan Chí Tâm','1992-05-12','Hồ Chí Minh','0909878888','Nhân viên',1),('E04','Vũ Thái','1990-09-09','Hồ Chí Minh','0907876976','Nhân viên',1),('E05','Ưng Hoàng Phi','1997-03-04','Hồ Chí Minh','0906543342','Nhân viên',1);
...
-- Dump completed on 2020-05-08  0:03:47
