 ...
 * @author User
 */
public class HienThiNhaCungCap extends javax.swing.JPanel {
    ...
    public HienThiNhaCungCap() {
        initComponents();
        setDataToTable(qlncc.getDsncc(), mtb);
    ...
    private void setDataToTable(ArrayList<NhaCungCap> data, MyTable table) {
        ...
        for (NhaCungCap ncc : data) {
            table.addRow(new String[]{String.valueOf(stt), ncc.getMaNCC(), ncc.getTenNCC(), ncc.getDiaChi(), ncc.getSDT()});
            stt++;
        }
    }
    ...
    private void txSearchOnChange() {
        setDataToTable(qlncc.search(txTim.getText(), cbTypeSearch.getSelectedItem().toString()), mtb);
    }
    ...
    private void initComponents() {
        ...
        cbTypeSearch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã nhà cung cấp", "Tên nhà cung cấp", "Địa chỉ", " " }));
        ...
        mtb.setHeaders(new String[]{"STT", "Mã NCC", "Tên NCC", "Địa chỉ", "SDT"});
        mtb.setColumnsWidth(new double[]{.5, .5, 2, 3,2});
