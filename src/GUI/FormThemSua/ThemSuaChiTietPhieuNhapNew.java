 ...
 * @author User
 */
public class ThemSuaChiTietPhieuNhapNew extends javax.swing.JFrame {
    ...
    public ThemSuaChiTietPhieuNhapNew(String _type, String _mapn, String _masp) {
        initComponents();
        ...
        if (this.type.equals("Thêm")) {
            ...
            this.setTitle("Sửa chi tiết " + this.masp + " trên phiếu nhập" + this.mapn);

            for (ChiTietPhieuNhap ctpn : dsctpn) {
                if (ctpn.getMaPN().equals(this.mapn) && ctpn.getMaSP().equals(this.masp)) {
                    this.ctpnSua = ctpn;
                }
            }
            ...
            txSLuong.setText(String.valueOf(ctpnSua.getsLuong()));
    ...
    private void btnThemChiTietPhieuNhapMouseClicked() {
        if (checkEmpty()) {
            ...
            ChiTietPhieuNhap ctpn = new ChiTietPhieuNhap(mapn, maspThem, soluong, dongia);

//            for (ChiTietHoaDon ct : dscthd) {
//                qlcthd.add(ct);
//            }
            if (qlctpn.add(ctpn) != null) {
