...
public class QuanLySanPham extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSuaSP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/qlchdt/assets/icons8_support_30px.png"))); // NOI18N
        btnSuaSP.setText("Sửa");
        btnSuaSP.setMaximumSize(new java.awt.Dimension(140, 40));
        btnSuaSP.setMinimumSize(new java.awt.Dimension(140, 40));
        btnSuaSP.setPreferredSize(new java.awt.Dimension(140, 40));
        ...
        btnLamMoi.setMaximumSize(new java.awt.Dimension(140, 50));
        btnLamMoi.setMinimumSize(new java.awt.Dimension(140, 50));
        btnLamMoi.setPreferredSize(new java.awt.Dimension(140, 50));
