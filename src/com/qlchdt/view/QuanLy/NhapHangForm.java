...
public class NhapHangForm extends FormHang {
    ...
    private void btnNhapHangOnClick() {
        ...
        if (reply == JOptionPane.OK_OPTION) {
            new WritePDF().writePhieuNhap(txMaPN.getText());
        }
...
//    }
    ...
    private void initComponents() {
        ...
        btnChonKH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/qlchdt/assets/supplier.png"))); // NOI18N
        ...
        btnNhapHang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/qlchdt/assets/icons8_us_dollar_30px.png"))); // NOI18N
        btnNhapHang.setText("NHẬP HÀNG");
        btnNhapHang.setPreferredSize(new java.awt.Dimension(180, 40));
