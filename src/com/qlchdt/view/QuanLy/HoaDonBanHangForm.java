...
//        txGioLap.setText(LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")));
    ...
    private void initComponents() {
        ...
        btnChonKH.setText("Tìm khách");
        btnChonKH.setMaximumSize(new java.awt.Dimension(150, 40));
        btnChonKH.setMinimumSize(new java.awt.Dimension(150, 40));
        btnChonKH.setPreferredSize(new java.awt.Dimension(150, 40));
        ...
        btnSua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/qlchdt/assets/pencil.png"))); // NOI18N
        btnSua.setText("Sửa");
        ...
        btnLamMoi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/qlchdt/assets/refresh.png"))); // NOI18N
